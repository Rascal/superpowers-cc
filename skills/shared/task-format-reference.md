...
| `gateScope` | "once" \| "per-target" \| "one-then-all" \| string | no | How many times / across how many targets the gate should run. Set by `specifying-gates` (Q3). Free-form string allowed for custom rules. |
